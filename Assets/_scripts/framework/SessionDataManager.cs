...
public class SessionDataManager {
	...
	public static SessionDataManager BeginSession(SubjectData currentSubject) {
		SessionDataManager sessionDataManager = GetSessionDataManager();
		sessionDataManager.CreateSessionData(currentSubject);
	...
	private void CreateSessionData(SubjectData currentSubject) {
		return;
