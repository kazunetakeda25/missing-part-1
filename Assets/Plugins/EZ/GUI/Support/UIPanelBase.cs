...
public abstract class UIPanelBase : MonoBehaviour, IUIContainer, IUIObject
{
	...
	*/
	...
	protected virtual void SetupTransitionSubjects()
	{
		...
		// we'll want to transition:
		Component[] texts = transform.GetComponentsInChildren(typeof(UITextBase), true);
	...
	public void AddChild(GameObject go)
	{
		...
		IUIObject obj = (IUIObject)GetComponent(typeof(IUIObject));
#else
		...
		if (obj != null)
		{
			if (!ReferenceEquals(obj, this) && !ReferenceEquals(obj.Container, this))
				obj.Container = this;
			uiObjs.Add(new EZLinkedListNode<IUIObject>(obj));
		}
		else
		{
			...
			if (panel != null)
			{
				if (!ReferenceEquals(panel, this) && !ReferenceEquals(panel.Container, this))
	...
	{
		if (ReferenceEquals(go, gameObject))
			return;
...
#if UNITY_5_0 || UNITY_5_1 || UNITY_5_2 || UNITY_5_3 || UNITY_5_4 || UNITY_5_5 || UNITY_5_6 || UNITY_5_7 || UNITY_5_8 || UNITY_5_9
			else if (t.gameObject.GetComponent(typeof(IUIContainer)) as Component != null)
#else
