...
public class UIScrollList : MonoBehaviour, IUIObject
{
	...
	protected void Start()
	{
		...
		bool oldVal = positionItemsImmediately;
		positionItemsImmediately = false;
		...
		positionItemsImmediately = oldVal;
	...
	// Immediately finishes off the clear queue
	...
	public void OnInput(POINTER_INFO ptr)
	{
		...
		switch (ptr.evt)
		{
			...
			case POINTER_INFO.INPUT_EVENT.MOVE_OFF:
				if (!noTouch) // If a touch was in progress, release:
					PointerReleased();
				break;
		}
	...
	public bool RequestContainership(IUIContainer cont)
	{
		...
		while (t != null)
		{
			...
			else
			{
			    ...
			    if (t.gameObject.GetComponent(typeof(IUIContainer)) as Component != null)
					return false;
#else
