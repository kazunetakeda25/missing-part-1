	...
	public override void OnInput(ref POINTER_INFO ptr)
	{
		...
		if (hasFocus)
		{
			if (ptr.evt == POINTER_INFO.INPUT_EVENT.PRESS && caret != null && allowClickCaretPlacement)
			{
				...
				RaycastHit hit;
				if (_collider.Raycast(ptr.ray, out hit, ptr.rayDepth))
				{
...
*/
	...
	{
		get { return SpriteText.Alignment_Type.Left; }
	}

	public override SpriteText.Anchor_Pos DefaultTextAnchor
	{
		get { return SpriteText.Anchor_Pos.Upper_Left; }
	}
	...
	protected void CreateCaret()
	{
		...
		if (!managed)
		{
			if (caret.spriteMesh != null)
				((SpriteMesh)caret.spriteMesh).material = _renderer.sharedMaterial;
		}
		else
		{
			if (manager != null)
