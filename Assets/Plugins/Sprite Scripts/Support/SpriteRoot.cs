	...
	*/
	...
	public virtual void Copy(SpriteRoot s)
	{
		...
		if (!managed)
		{
			...
			{
				_renderer.sharedMaterial = s._renderer.sharedMaterial;
			}
		}
		...
		if (m_spriteMesh != null)
		{
			...
			{
				((SpriteMesh)m_spriteMesh).material = _renderer.sharedMaterial;
				SetPixelToUV(m_spriteMesh.texture);
			}
		}
...
*/
	...
	public void CalcPixelToUV()
	{
		...
		{
			if (_renderer != null && _renderer.sharedMaterial != null && _renderer.sharedMaterial.mainTexture != null)
				SetPixelToUV(_renderer.sharedMaterial.mainTexture);
		}
	}
