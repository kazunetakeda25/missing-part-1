...
#if UNITY_4 || UNITY_4_1 || UNITY_4_2 || UNITY_4_3 || UNITY_4_4 || UNITY_4_5 || UNITY_4_6 || UNITY_4_7 || UNITY_4_8 || UNITY_4_9 || UNITY_5_0 || UNITY_5_1 || UNITY_5_2 || UNITY_5_3 || UNITY_5_4 || UNITY_5_5 || UNITY_5_6 || UNITY_5_7 || UNITY_5_8 || UNITY_5_9
		mesh.MarkDynamic();
#endif
		if (persistent)
...
// 			}
		...
		// Perform necessary updates since things changed:
		OnChange();
	}
...
//			gameObject.active = ((Component)parentControl).gameObject.active;
	...
	{
		if (text is SpriteText)
			Copy((SpriteText)text);
	}
	...
	public override string MaskingCharacter
	{
		...
		set
		{
			if (maskingCharacter.CompareTo(value) != 0)
			{
	...
	public override bool RemoveUnsupportedCharacters
	{
		...
		set
		{
			if (removeUnsupportedCharacters != value)
			{
	...
	{
		get { return parseColorTags; }
		set
		{
			if (parseColorTags != value)
			{
				parseColorTags = value;
				Text = text;
			}
		}
	}
	...
	public static SpriteText CreateInstance(IControl control)
	{
		...
		spriteText.offsetZ = control.TextOffsetZ;

		// Make it persistent or not:
		spriteText.Persistent = control.Persistent;

		// Tell the text object the control is its parent
		spriteText.Parent = control;

		// Anchor and align centered by default:
		spriteText.anchor = control.DefaultTextAnchor;
		spriteText.alignment = control.DefaultTextAlignment;
		spriteText.pixelPerfect = true;
		if (control is AutoSpriteBase)
			spriteText.SetCamera(((AutoSpriteBase)control).RenderCamera);
	...
	// than 10 seconds:
#if (UNITY_3_0 || UNITY_3_1 || UNITY_3_2 || UNITY_3_3 || UNITY_3_4 || UNITY_3_5 || UNITY_3_6 || UNITY_3_7 || UNITY_3_8 || UNITY_3_9 || UNITY_4_0 || UNITY_4_1 || UNITY_4_2 || UNITY_4_3 || UNITY_4_4 || UNITY_4_5 || UNITY_4_6 || UNITY_4_7 || UNITY_4_8 || UNITY_4_9 || UNITY_5_0 || UNITY_5_1 || UNITY_5_2 || UNITY_5_3 || UNITY_5_4 || UNITY_5_5 || UNITY_5_6 || UNITY_5_7 || UNITY_5_8 || UNITY_5_9) && UNITY_EDITOR
	void Update() 
	{
		DoMirror();
	}
